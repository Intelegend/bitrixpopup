...
<div class="container-fluid">
  <div id="closeablecard" class="card" style="width: 50rem;">
  <div class="row">
    <div class="col">
    <div class="card" style="float: right; border: none">
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
    ...
    <div class="card-body">
      <h5 class="card-title" style="font-size: 16px; text-align:justify"> <b>Заполните заявку на консультацию</b></h5>
      <h6><p class="card-text" style="font-size: 14px; width: 50rem;">
  ...
  <div class="row g-2">
    ...
    <div class="col-sm-12">
      <textarea class="form-control bg-light text-dark mw-150" placeholder="Напишите какой у Вас вопрос?" aria-label="Напишите какой у Вас вопрос?" aria-describedby="inputGroup-sizing-default" style="resize: none; border: none;"></textarea>
    </div>
  </div>
  </div>
  <br>
  ...
  <h6 style="font-size: 10px;"><a href="#" class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Я соглашаюсь </a>на обработку персональных данных</h6>
  </div>
  </div>
  </div>
    </div>
